		...
		<div class="gtco-container">
				...
				<div class="col-md-12">
					<ul id="gtco-portfolio-list">
						<li class="two-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/img_1.jpg); "> 
							<a href="https://www.cargocar.app/" class="color-1">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4 text-center animate-box">
					<a href="https://api.whatsapp.com/send?phone=5511946708862" class="btn btn-primary btn-lg btn-block">Gostou do trabalho? Vamos fazer o seu ?</a>
				</div>
			</div>
